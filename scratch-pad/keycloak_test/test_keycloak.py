...
# from https://fastapi-keycloak.code-specialist.com/full_example/

app = FastAPI()
idp = FastAPIKeycloak(
    server_url="http://localhost:8085/auth",
    client_id="chosim_client",
    client_secret="obsQvW9vQ48aQxDNU2Dok7AgqzmLq91e",        # copy from config page
    admin_client_secret="obsQvW9vQ48aQxDNU2Dok7AgqzmLq91e",  # no idea what this is
    realm="chosm",
